...
planet1 = CelestialBody("R", 'r', [-150,-500], [2.72,deg2rad(90)],  5, 15, 9E1);
planet2 = CelestialBody("O",  o,  [-100,-500], [2.69,deg2rad(90)],  5, 15, 9E1);
...
planet6 = CelestialBody("I",  i,  [100,-500],  [2.69,deg2rad(90)],  5, 15, 9E1);
planet7 = CelestialBody("V",  v,  [150,-500],  [2.72,deg2rad(90)],  5, 15, 9E1);


uni = Universe([planet1,planet2,planet3,planet4,planet5,planet6,planet7],timestep,x_limit, y_limit);
uni.bigBang(frames,trailType);
